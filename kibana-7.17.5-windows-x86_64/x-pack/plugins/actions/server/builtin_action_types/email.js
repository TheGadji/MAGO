...
function validateParams(configurationUtilities, paramsObject) {
...
function getActionType(params) {
  ...
  return {
    ...
    validate: {
      ...
      params: _configSchema.schema.object(ParamsSchemaProps, {
        validate: (0, _lodash.curry)(validateParams)(configurationUtilities)
      })
    },
