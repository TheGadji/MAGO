...
exports.getPreferredEsType = exports.formatTimelineData = exports.buildObjectForFieldPath = exports.buildFieldsRequest = void 0;
...
const buildFieldsRequest = (fields, excludeEcsData) => (0, _fp.uniq)([...fields.filter(f => !f.startsWith('_')), ...(excludeEcsData ? [] : _constants.TIMELINE_EVENTS_FIELDS)]).map(field => ({
  field,
...
const getPreferredEsType = esTypes => {
...
exports.getPreferredEsType = getPreferredEsType;