...
exports.registerRulePreviewPrivilegeDeprecations = void 0;
  ...
  deprecationsService.registerDeprecations({
    getDeprecations: async context => {
      ...
      if (getKibanaRoles) {
        ...
        rolesWhichReadSignals = (_roles$filter = roles === null || roles === void 0 ? void 0 : roles.filter(role => (0, _utils.roleIsExternal)(role) && (0, _utils.roleHasReadAccess)(role) && !(0, _utils.roleHasReadAccess)(role, PREVIEW_INDEX_PREFIX))) !== null && _roles$filter !== void 0 ? _roles$filter : [];
      }
