...
var _alerts_as_data_privileges = require("./deprecations/alerts_as_data_privileges");
/*
...
class Plugin {
  ...
  setup(core, plugins) {
    var _plugins$usageCollect, _plugins$encryptedSav, _plugins$security, _plugins$security2, _plugins$security3;
    ...
    (0, _alerts_as_data_privileges.registerAlertsIndexPrivilegeDeprecations)({
      deprecationsService: core.deprecations,
      getKibanaRoles: (_plugins$security3 = plugins.security) === null || _plugins$security3 === void 0 ? void 0 : _plugins$security3.privilegeDeprecationsService.getKibanaRoles
    });
    return {};
  }
