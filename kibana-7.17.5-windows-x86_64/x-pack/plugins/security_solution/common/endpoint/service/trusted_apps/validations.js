...
exports.isValidHash = exports.isPathValid = exports.hasSimpleExecutableName = exports.getDuplicateFields = void 0;
...
const hasSimpleExecutableName = ({
  ...
  const separator = os === _types.OperatingSystem.WINDOWS ? '\\' : '/';
