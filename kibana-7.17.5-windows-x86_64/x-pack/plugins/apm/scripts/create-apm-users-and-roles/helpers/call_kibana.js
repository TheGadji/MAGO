...
const getBaseUrl = (0, _lodash.once)(async kibanaHostname => {
  try {
    ...
    if (isAxiosError(e)) {
      var _e$response$headers$l, _e$response, _e$response$headers;

      const location = (_e$response$headers$l = (_e$response = e.response) === null || _e$response === void 0 ? void 0 : (_e$response$headers = _e$response.headers) === null || _e$response$headers === void 0 ? void 0 : _e$response$headers.location) !== null && _e$response$headers$l !== void 0 ? _e$response$headers$l : '';
