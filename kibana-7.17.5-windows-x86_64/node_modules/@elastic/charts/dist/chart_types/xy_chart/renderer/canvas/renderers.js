...
function renderXYChartCanvas2d(ctx, dpr, props) {
    ...
    (0, canvas_1.withContext)(ctx, function () {
        ...
        (0, canvas_1.renderLayers)(ctx, [
            ...
            function () { return (0, annotations_1.renderAnnotations)(ctx, annotationDimensions, annotationSpecs, rotation, renderingArea, true); },
            ...
            function () { return (0, areas_1.renderAreas)(ctx, imgCanvas, geometries.areas, sharedStyle, rotation, renderingArea, highlightedLegendItem); },
            ...
            function () { return (0, annotations_1.renderAnnotations)(ctx, annotationDimensions, annotationSpecs, rotation, renderingArea, false); },
            function () {
                return debug &&
                    (0, canvas_1.withContext)(ctx, function () {
                        var _a;
