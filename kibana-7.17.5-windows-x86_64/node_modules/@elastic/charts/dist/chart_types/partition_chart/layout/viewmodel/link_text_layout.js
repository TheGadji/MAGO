...
function linkTextLayout(rectWidth, rectHeight, measure, config, nodesWithoutRoom, currentY, anchorRadius, rawTextGetter, valueGetter, valueFormatter, maxTextLength, diskCenter, containerBgColor) {
    if (containerBgColor === void 0) { containerBgColor = colors_1.Colors.White.keyword; }
    ...
    if ((0, color_library_wrappers_1.colorToRgba)(containerBgColor)[3] < 1) {
        logger_1.Logger.expected("Text contrast requires a opaque background color, using white as fallback", 'an opaque color', containerBgColor);
    }
    var textColor = linkLabel.textColor === common_1.ColorVariant.Adaptive ? (0, fill_text_color_1.fillTextColor)(containerBgColor) : linkLabel.textColor;
