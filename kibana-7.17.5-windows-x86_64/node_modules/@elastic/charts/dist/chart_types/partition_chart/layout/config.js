...
exports.config = exports.configMetadata = exports.percentFormatter = exports.VALUE_GETTERS = exports.ratioValueGetter = exports.percentValueGetter = exports.MODEL_KEY = exports.sumValueGetter = void 0;
...
exports.configMetadata = {
    ...
    fillLabel: {
        type: 'group',
        values: __assign(__assign({ textColor: { type: 'color', dflt: common_1.ColorVariant.Adaptive } }, fontSettings), { valueGetter: {
                dflt: sumValueGetter,
                type: 'function',
            }, valueFormatter: {
                dflt: defaultFormatter,
                type: 'function',
            }, valueFont: valueFont, padding: {
                type: 'group',
                values: {
                    top: {
                        dflt: 2,
    ...
    linkLabel: {
        ...
        values: __assign(__assign({ maximumSection: {
            ...
            }, textColor: { dflt: common_1.ColorVariant.Adaptive, type: 'color' }, minimumStemLength: {
                dflt: 0,
                min: 0,
                max: 16,
                type: 'number',
...
exports.config = (0, config_objects_1.configMap)(function (item) { return item.dflt; }, exports.configMetadata);
