...
exports.getDebugStateSelector = (0, create_selector_1.createCustomCachedSelector)([geometries_1.geometries, compute_legend_1.computeLegendSelector, get_highlighted_area_1.getHighlightedAreaSelector, get_highlighted_area_1.getHighlightedDataSelector], function (geoms, legend, pickedArea, highlightedData) {
    return {
            ...
            x: [
                {
                    ...
                    labels: geoms.heatmapViewModel.xValues.map(function (_a) {
                        var text = _a.text;
                        return text;
                    }),
                    values: geoms.heatmapViewModel.xValues.map(function (_a) {
                        var value = _a.value;
                        return value;
                    }),
