...
const enhancedEsSearchStrategyProvider = (legacyConfig$, logger, usage, useInternalUser = false) => {
  ...
  function asyncSearch({
    ...
    const search = async () => {
      ...
      const params = id ? (0, _request_utils.getDefaultAsyncGetParams)(searchSessionsClient.getConfig(), options) : { ...(await (0, _request_utils.getDefaultAsyncSubmitParams)(uiSettingsClient, searchSessionsClient.getConfig(), (_request$params = request.params) === null || _request$params === void 0 ? void 0 : _request$params.body, options)),
        ...request.params
      };
      const promise = id ? client.asyncSearch.get({ ...params,
        id
      }) : client.asyncSearch.submit(params);
      const {
        body,
        headers
      } = await (0, _es_search.shimAbortSignal)(promise, options.abortSignal);
  ...
  async function rollupSearch(request, options, {
    ...
    const querystring = { ...(0, _es_search.getShardTimeout)(legacyConfig),
      ...
      ...(await (0, _es_search.getDefaultSearchParams)(uiSettingsClient, (_request$params2 = request.params) === null || _request$params2 === void 0 ? void 0 : _request$params2.body)),
      ...params
    };
    ...
    try {
      ...
      const esResponse = await (0, _es_search.shimAbortSignal)(promise, options === null || options === void 0 ? void 0 : options.abortSignal);
