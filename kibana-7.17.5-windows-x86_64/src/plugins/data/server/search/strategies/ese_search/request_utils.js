...
async function getDefaultAsyncSubmitParams(uiSettingsClient, searchSessionsConfig, body = {}, options = {}) {
  ...
  return {
    ...
    ...(await (0, _es_search.getDefaultSearchParams)(uiSettingsClient, body))
  };
}
/**
 @internal
