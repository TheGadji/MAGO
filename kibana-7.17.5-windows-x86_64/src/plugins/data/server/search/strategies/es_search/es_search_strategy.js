  ...
  search: (request, {
    ...
    const search = async () => {
      try {
        ...
        const params = { ...(await (0, _request_utils.getDefaultSearchParams)(uiSettingsClient, (_request$params = request.params) === null || _request$params === void 0 ? void 0 : _request$params.body)),
