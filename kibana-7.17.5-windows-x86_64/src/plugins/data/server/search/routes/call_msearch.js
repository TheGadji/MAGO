...
function getCallMsearch(dependencies) {
  ...
  return async params => {
    ...
    const timeout = (0, _.getShardTimeout)(config); // track_total_hits/enable_fields_emulation are not supported by msearch
    ...
    try {
      ...
      const response = await (0, _.shimAbortSignal)(promise, params.signal);
      return {
        body: { ...response,
          body: {
            responses: (_response$body$respon = response.body.responses) === null || _response$body$respon === void 0 ? void 0 : _response$body$respon.map(r => (0, _.shimHitsTotal)(r))
          }
        }
      };
    } catch (e) {
