  ...
  return {
    ...
    [_constants.UI_SETTINGS.GRAPHITE_URL]: {
      ...
      description: _i18n.i18n.translate('timelion.uiSettings.graphiteURLDescription', {
        defaultMessage: '{experimentalLabel} The <a href="https://www.hostedgraphite.com/UID/ACCESS_KEY/graphite" target="_blank" rel="noopener">URL</a> of your graphite host.  If no URL is set, the first graphite URL configured in kibana.yml is used.',
        values: {
